...
function saveFigure(app)
    ...
    ylabel('Amplitud normalizada', 'FontSize', 20);
    ...
    ylabel('Frecuencia (Hz)', 'FontSize', 20);
...
function actualizarEscalograma(app, muestra)
    ...
    c.Label.String = 'Potencia';
    xlabel(app.UIAxes3, 'Tiempo (seg)', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    ylabel(app.UIAxes3, 'Frecuencia (Hz)', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    title(app.UIAxes3, 'Escalograma', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    ...
    xlabel(app.UIAxes2, 'Frecuencia (Hz)', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    ylabel(app.UIAxes2, 'Potencia', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    title(app.UIAxes2, 'Espectro de potencia (Hz)', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    lo1 = escaloerrinf1;
    hi1 = escaloerrsup1;
    ...
    xlabel(app.UIAxes, 'Tiempo (s)', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    ylabel(app.UIAxes, 'Amplitud normalizada', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    title(app.UIAxes, 'Señal ERG', 'FontSize', 20, 'FontName', 'Arial', 'Interpreter', 'none');
    box(app.UIAxes, 'off');
    grid(app.UIAxes, 'off');
    set(app.UIAxes, 'Color', 'w');
    set(app.UIAxes, 'TickDir', 'out');
    set(findall(app.UIAxes, '-property', 'FontSize'), 'FontSize', 17);
